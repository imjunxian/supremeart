<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/default.Master" AutoEventWireup="true" CodeBehind="PlusAddress.aspx.cs" Inherits="SupremeArt.Buyer.PlusAddress" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
     <br />
    <br />
    <form runat="server" id="Add_Address">
    <div class="container">
               ...
               <asp:Literal ID="litResult" runat="server"></asp:Literal>
                    <div class="row">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                      ...
                                      <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtState" ForeColor="Red" Display="Dynamic" ErrorMessage="Please Enter [Alphabet] only" ValidationExpression="^[a-zA-Z ]*$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                 ...
                                 <tr>
                                    <th>State , Area</th>
                                    <td>
                                        <!--<asp:TextBox ID="txtState" runat="server" type="text" CssClass="form-control"  name="state"></asp:TextBox>-->
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter [State , Area]" ForeColor="Red" Display="Dynamic" ControlToValidate="ddstate"></asp:RequiredFieldValidator>
                                        <!--<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtState" ForeColor="Red" Display="Dynamic" ErrorMessage="Please Enter [Alphabet] only" ValidationExpression="^[a-zA-Z ]*$"></asp:RegularExpressionValidator>-->
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Label As</th>
                                    <td>
                                          <asp:RadioButtonList CssClass="form-check-inline" ID="label" runat="server" RepeatDirection="Horizontal">
                                         <asp:ListItem Value="Office">Office</asp:ListItem>
                                         <asp:ListItem Value="Home">Home</asp:ListItem>
                                        </asp:RadioButtonList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Please Select [Destination Type]" ForeColor="Red" Display="Dynamic" ControlToValidate="label"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                        ...
                        <div class="text-center">
                            <asp:Button ID="btnChange" class="btn btn-success" runat="server" Text="Add Address" OnClick="btnChange_Click"/>
                        </div>
