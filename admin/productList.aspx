<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/AdminSite.Master" AutoEventWireup="true" CodeBehind="productList.aspx.cs" Inherits="SupremeArt.admin.productList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
      <div class="card">
              ...
              <div class="card-body">
                  ...
                  <input type="hidden" id="sellerid" value="" runat="server"/>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                     ...
                                     <p>Confirm delete order [<span ID="deleteId"></span>] ?</p> <p class="text-danger">Caution: Changes cannot be made after delete successful.</p> 
